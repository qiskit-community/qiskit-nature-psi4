...
"""
Code inside the test is the Qiskit Nature Psi4 sample from the readme.
...
import re
from test import QiskitNaturePsi4TestCase


class TestReadmeSample(QiskitNaturePsi4TestCase):
